...
function doPost(e) {
  ...
  if (parsedData !== undefined){
    ...
    var date_now = Utilities.formatDate(new Date(), "IST", "yyyy/MM/dd"); // gets the current date
    var time_now = Utilities.formatDate(new Date(), "IST", "hh:mm:ss a"); // gets the current time
    ...
    switch (parsedData.command) {
      ...
      case "insert_row":
         ...
         sheet.getRange('F2').setValue(value3);   // publish value0 from Arduino code to cell F2
         sheet.getRange('G2').setValue(value4);   // publish value1 from Arduino code to cell G2
         sheet.getRange('H2').setValue(value5);   // publish value2 from Arduino code to cell H2
         sheet.getRange('I2').setValue(value6);   // publish value0 from Arduino code to cell I2
      ...
      case "append_row":
         ...
         publish_array [5] = value3;   // add value2 from Arduino code to position 5 in publish_array
         publish_array [6] = value4;   // add value2 from Arduino code to position 6 in publish_array
         publish_array [7] = value5;   // add value2 from Arduino code to position 7 in publish_array
         publish_array [8] = value6;   // add value2 from Arduino code to position 8 in publish_array
