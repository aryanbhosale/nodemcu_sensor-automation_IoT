...
void loop() {
  ...
  char  replyPacket[payload_len];  // a reply string to send back
  payload.toCharArray(replyPacket, payload_len);


  Udp.beginPacket("YOUR_LAPTOP'S_IP_ADDRESS", 4210);
  Udp.write(replyPacket);
  Udp.endPacket();
  Serial.println("\n");


  // // Publish data to Python UDP Client
